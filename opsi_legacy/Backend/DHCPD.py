...
from opsi_legacy.Object import ConfigState, Host, OpsiClient
from opsi_legacy.Types import forceBool, forceDict, forceHostId, forceObjectClass
...
class DHCPDBackend(ConfigDataBackend):
	...
	def _getResponsibleDepotId(self, clientId: str) -> str:
		...
		configStates = self._context.configState_getObjects(configId="clientconfig.depot.id", objectId=clientId)
		try:
