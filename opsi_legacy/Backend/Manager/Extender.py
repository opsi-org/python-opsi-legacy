...
from opsi_legacy.Backend.Manager.AccessControl import BackendAccessControl
from opsi_legacy.Exceptions import *  # This is needed for dynamic extension loading  # noqa: F403
from opsi_legacy.Exceptions import BackendConfigurationError
from opsi_legacy.Object import *  # This is needed for dynamic extension loading  # noqa: F403
from opsi_legacy.Types import *  # This is needed for dynamic extension loading  # noqa: F403
				...
				for confFile in _getExtensionFiles(self._extensionConfigDir):
					...
					for function_name, function in loc.items():
						...
						if isinstance(function, types.FunctionType):
							if hasattr(self, function_name) and not self._extensionReplaceMethods:
								continue
							logger.trace(
