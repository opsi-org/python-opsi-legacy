...
from opsi_legacy.Backend.Base.Extended import ExtendedConfigDataBackend, get_function_signature_and_args
...
class BackendDispatcher(Backend):
	...
	def __loadBackends(self, kwargs=None):
		...
		for backend in collectedBackends:
			...
			moduleName = f"opsi_legacy.Backend.{backend_config['module']}"
