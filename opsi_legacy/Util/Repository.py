...
from opsi_legacy.Types import forceBool, forceFilename, forceInt, forceUnicode, forceUnicodeList
...
if os.name == "nt":
	from opsi_legacy.System.Windows import getFreeDrive
...
class SpeedLimiter:
	...
	def _start_network_performance_counter(self):
		...
		retry = 0
		exception = None
		from opsi_legacy.System import NetworkPerformanceCounter, getDefaultNetworkInterfaceName
...
class Repository:
	...
	def _transfer(self, transferDirection, src, dst, size, progressSubject=None, pauseEvent=None):
		logger.debug(
