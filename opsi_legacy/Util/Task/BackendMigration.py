...
from opsi_legacy.Exceptions import BackendConfigurationError, BackendModuleDisabledError
from opsi_legacy.System import execute
from opsi_legacy.Util.Task.Backup import OpsiBackup
from opsi_legacy.Util.Task.Rights import set_rights
from opsi_legacy.Util.Task.UpdateBackend.MySQL import updateMySQLBackend
...
def migrate_file_to_mysql(create_backup: bool = True, restart_services: bool = True) -> bool:
	bm_config = {
